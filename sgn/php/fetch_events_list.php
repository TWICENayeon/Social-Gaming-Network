				...
				echo "<div class='eventCont'>
							<div class='templateEvent'>
								...
								<div class='eventViewPostsButtons'>
									<button type='button' class='btn btn-primary' id='eventButton' data-toggle='modal' data-target='#eventModal_" . (string)$future_counter .  "'>View</button>
									<button type='button' class='btn btn-primary' id='eventPosts' data-toggle='modal' data-target='#eventPostsModal_" . (string)$future_counter ."'>Posts</button>			  
								</div>
							</div>
						</div>";	
				++$future_counter;
